...
class xnTwist(object):
    ...
    def get_administrators(self):
        ...
        """
        return self.make_get_request(self.api_path + "administrators")
    ...
    def get_feed(self):
        ...
        (``/feed``).
        """
        return self.make_get_request(self.api_path + "feed")

    def get_mappings(self):
        """
        Make ``GET`` request to branch with character mappings (``/mappings``).
        """
        return self.make_get_request(self.api_path + "mappings")
    ...
    def get_non_basic_chars(self):
        ...
        """
        return self.make_get_request(self.api_path + "non_basic_characters")
    ...
    def get_unmapped_chars(self):
        ...
        (``/unmapped_characters``).
        """
        return self.make_get_request(self.api_path + "unmapped_characters")
    ...
    def get_basic_chars(self):
        ...
        (``/basic_characters``).
        """
        return self.make_get_request(self.api_path + "basic_characters")
    ...
    def get_suggested_deprecations(self):
        ...
        """
        return self.make_get_request(self.api_path + "suggested_deprecations")
    ...
    def get_depricated_chars(self):
        ...
        """
        return self.make_get_request(self.api_path + "depricated_characters")
